  ...
  return (
    <div id="contact" className="container mx-auto p-8" title='contact'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="col-span-1" data-aos='fade-right' data-aos-duration="4000" data-aos-delay='400'>
        ...
        <div className="col-span-1" data-aos='fade-left' data-aos-duration="4000" data-aos-delay='400'>
