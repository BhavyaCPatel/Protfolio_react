...
return (
    ...
    <div className='mx-10 my-10'>
        ...
        <div className="container border-2 bg-green-blue rounded-lg my-6" data-aos='fade-left' data-aos-duration="4000" data-aos-delay='1000'>
        ...
        <div className="container border-2 bg-dgreen-blue rounded-lg my-6" data-aos='fade-right' data-aos-duration="4000" data-aos-delay='1400'>
            <div className="text-navy-blue">
        ...
        <div className="container border-2 bg-dgreen-blue rounded-lg my-6" data-aos='fade-right' data-aos-duration="4000" data-aos-delay='1000'>
            <div className="text-navy-blue">
        ...
        <div className="container border-2 bg-dgreen-blue rounded-lg my-6" data-aos='fade-right' data-aos-duration="4000" data-aos-delay='800'>
            <div className="text-navy-blue">
        ...
        <div className="container border-2 bg-green-blue rounded-lg my-6" data-aos='fade-left' data-aos-duration="4000" data-aos-delay='800'>
            <div className="text-navy-blue">
